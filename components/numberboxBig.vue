<template>
	<view class="operatebar flex align-center">
		<div class="minusBtn" @tap="reduce">
			<image src="/static/freshbean/reduce.png" mode="widthFix"></image>
		</div>
		<input type="number" v-model="inputValue" :disabled="isdisabled" @blur="blur" class="num"  />
		<div class="addBtn"@tap="plus">
			<image src="/static/freshbean/plus.png" mode="widthFix"></image>
		</div>
	</view>
</template>
